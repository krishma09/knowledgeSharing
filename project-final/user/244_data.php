...
<h4>C++ References vs Pointers</h4>
...
<h4>Creating References in C++</h4>
...
<pre class="result notranslate">int    i = 17;
</pre>
<p>We can declare reference variables for i as follows.</p>
<pre class="result notranslate">int&amp;    r = i;
</pre>
...
<pre class="result notranslate">Value of i : 5
...
<tr><td><p>References as parameters</a></p></td><td>C++ supports passing references as function parameter more safely than parameters.</td> </tr>
<tr><td><p>Reference as return value</a></p></td><td>You can return reference from a C++ function like a any other data type can be returned.</td> </tr>
</tbody></table>
...
<div class="row">
<a href="243_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="245_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
