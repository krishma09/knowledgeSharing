...
<h4>I/O Library Header Files</h4>
...
<h4>The standard output stream (cout)</h4>
...
<pre class="result notranslate">Value of str is : Hello C++
</pre>
...
<h4>The standard input stream (cin)</h4>
...
<pre class="result notranslate">Please enter your name: cplusplus
...
<pre class="prettyprint notranslate prettyprinted"><span class="pln">cin </span><span class="pun">&gt;&gt;</span><span class="pln"> name </span><span class="pun">&gt;&gt;</span><span class="pln"> age</span><span class="pun">;</span></pre>
<p>This will be equivalent to the following two statements:</p>
<pre class="result notranslate">cin &gt;&gt; name;
cin &gt;&gt; age;
</pre>
...
<div class="row">
<a href="245_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="247_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
