...
<p>Before creating an actual "Hello, World!" application using Node.js, let us see the components of a Node.js application. A Node.js application consists of the following three important components −</p>
<ul class="list">
<li><p><b>Import required modules</b> − We use the <b>require</b> directive to load Node.js modules.</p></li>
<li><p><b>Create server</b> − A server which will listen to client's requests similar to Apache HTTP Server.</p></li>
<li><p><b>Read request and return response</b> − The server created in an earlier step will read the HTTP request made by the client which can be a browser or a console and return the response.</p></li>
</ul>
<h4>Creating Node.js Application</h4>
<h5>Step 1 - Import Required Module</h5>
<p>We use the <b>require</b> directive to load the http module and store the returned HTTP instance into an http variable as follows −</p>
<pre class="result notranslate">var http = require("http");
</pre>
<h5>Step 2 - Create Server</h5>
...
<pre class="prettyprint notranslate prettyprinted"><span class="pln">http</span><span class="pun">.</span><span class="pln">createServer</span><span class="pun">(</span><span class="kwd">function</span><span class="pln"> </span><span class="pun">(</span><span class="pln">request</span><span class="pun">,</span><span class="pln"> response</span><span class="pun">)</span><span class="pln"> </span><span class="pun">{</span><span class="pln">
   ...
   </span><span class="com">// Send the response body as "Hello World"</span><span class="pln">
   response</span><span class="pun">.</span><span class="kwd">end</span><span class="pun">(</span><span class="str">'Hello World\n'</span><span class="pun">);</span><span class="pln">
...
<h5>Step 3 - Testing Request &amp; Response</h5>
<p>Let's put step 1 and 2 together in a file called <b>main.js</b> and start our HTTP server as shown below −</p>
...
console</span><span class="pun">.</span><span class="pln">log</span><span class="pun">(</span><span class="str">'Server running at http://127.0.0.1:8081/'</span><span class="pun">);</span></pre>
<p>Now execute the main.js to start the server as follows −</p>
<pre class="prettyprint notranslate prettyprinted"><span class="pln">$ node main</span><span class="pun">.</span><span class="pln">js</span></pre>
<p>Verify the Output. Server has started.</p>
<pre class="result notranslate">Server running at http://127.0.0.1:8081/
</pre>
<h4>Make a Request to the Node.js Server</h4>
<p>Open http://127.0.0.1:8081/ in any browser and observe the following result.</p>
<img src="images/nodejs_sample.jpg" alt="Node.js Sample">
...
<div class="row">
<a href="258_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="260_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
