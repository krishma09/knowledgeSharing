...
<img src="images/event_loop.jpg" alt="Event Loop">
...
<pre class="result notranslate">// Bind event and even handler as follows
eventEmitter.on('eventName', eventHandler);
</pre>
<p>We can fire an event programmatically as follows −</p>
<pre class="result notranslate">// Fire an event 
eventEmitter.emit('eventName');
</pre>
<h4>Example</h4>
<p>Create a js file named main.js with the following code −</p>
<pre class="prettyprint notranslate tryit prettyprinted"><span class="com">// Import events module</span><span class="pln">
...
</span><span class="com">// Create an event handler as follows</span><span class="pln">
   ...
   console</span><span class="pun">.</span><span class="pln">log</span><span class="pun">(</span><span class="str">'connection succesful.'</span><span class="pun">);</span><span class="pln">
  
   </span><span class="com">// Fire the data_received event </span><span class="pln">
...
</span><span class="com">// Bind the connection event with the handler</span><span class="pln">
...
</span><span class="com">// Bind the data_received event with the anonymous function</span><span class="pln">
eventEmitter</span><span class="pun">.</span><span class="pln">on</span><span class="pun">(</span><span class="str">'data_received'</span><span class="pun">,</span><span class="pln"> </span><span class="kwd">function</span><span class="pun">(){</span><span class="pln">
   console</span><span class="pun">.</span><span class="pln">log</span><span class="pun">(</span><span class="str">'data received succesfully.'</span><span class="pun">);</span><span class="pln">
</span><span class="pun">});</span><span class="pln">
...
<pre class="result notranslate">$ mnode main.js
</pre>
<p>IT should produce the following result −</p>
<pre class="result notranslate">connection successful.
data received successfully.
Program Ended.
</pre>
<h4>How Node Applications Work?</h4>
...
<div class="row">
<a href="262_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="264_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
