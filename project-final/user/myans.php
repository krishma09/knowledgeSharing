...
fk_email_id,a.ans_desc from que_tbl as q , ans_tbl as a where a.fk_q_id=q.pk_q_id and a.fk_email_id='$email' and a.flag='$flag' LIMIT {$page1}, {$noi}");
...
//			$desc=$row["q_desc"];
	...
	//	$_SESSION["id"]=$id;
			...
			echo '<figure class="sc_image alignleft sc_image_shape_round ">';
				...
				echo '<img alt="" height="100px" width="100px" src="../user_images/'.$photo.'"> ';
			//	echo $email;
