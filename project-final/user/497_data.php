...
<h4>Description</h4>
<p>The component's view can be defined by using the <i>template</i> which tells Angular how to display the component. The template describes how the component is rendered on the page. </p>
<h4>Example</h4>
<p>The below example describes use of template in the Angular 2:</p>
<pre class="prettyprint notranslate tryit prettyprinted"><span class="dec">&lt;!DOCTYPE html&gt;</span><span class="pln">
</span><span class="tag">&lt;html&gt;</span><span class="pln">
   </span><span class="tag">&lt;head&gt;</span><span class="pln">
      </span><span class="tag">&lt;title&gt;</span><span class="pln">Angular 2 Template</span><span class="tag">&lt;/title&gt;</span><span class="pln">
         ...
         </span><span class="typ">System</span><span class="pun">.</span><span class="kwd">import</span><span class="pun">(</span><span class="str">'app/template_main'</span><span class="pun">)</span><span class="pln">
...
</span><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">MyTemplate</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"./template_app.component"</span><span class="pln">  </span><span class="com">//importing component function</span><span class="pln">
...
<pre class="prettyprint notranslate prettyprinted"><span class="com">// component's metadata can be accessed using this primary Angular library</span><span class="pln">
   ...
   selector</span><span class="pun">:</span><span class="pln"> </span><span class="str">'my-app'</span><span class="pln"> </span><span class="com">//specifies selector for HTML element named 'app'</span><span class="pln">
</span><span class="pun">})</span><span class="pln">
  ...
  </span><span class="kwd">template</span><span class="pun">:</span><span class="pln"> </span><span class="str">'&lt;h4&gt;Welcome to the world of {{val}}&lt;/h4&gt;'</span><span class="pln">
</span><span class="pun">})</span><span class="pln">
   ...
   val </span><span class="pun">:</span><span class="pln"> </span><span class="str">'Tutorialspoint!!!'</span><span class="pln">
</span><span class="pun">}</span></pre>
<h4>Output</h4>
<p>When you run the above code, it will display the text specified within the <i>template</i> option which is defined in the <i>template_app.component.ts</i> file and holds component's companion template that tells Angular how to render a view.</p>
...
<ul class="list">
   <li>
      <p>Save above HTML code as <b>angular2_templates.html</b> file in your server root folder.</p>
   </li>
   <li>
      <p>Open this HTML file as http://localhost/angular2_templates.html and output as below gets displayed.</p>
   </li>
</ul>
...
<div class="row">
<a href="496_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="498_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
