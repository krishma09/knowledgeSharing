...
<h4>Description</h4>
<p>Data binding is the synchronization of data between  the model and view components. To display the component property, you can put its name in the view template, enclosed in double curly braces. Two-way data binding merges property and event binding in a single notation using the directive <i>ngModel</i>.</p>
<h4>Example</h4>
<p>The below example describes use of data binding in the Angular 2:</p>
<pre class="prettyprint notranslate tryit prettyprinted" style="cursor: default;"><span class="dec">&lt;!DOCTYPE html&gt;</span><span class="pln">
      ...
      </span><span class="tag">&lt;title&gt;</span><span class="pln">Data Binding</span><span class="tag">&lt;/title&gt;</span><span class="pln">
         ...
         </span><span class="typ">System</span><span class="pun">.</span><span class="kwd">import</span><span class="pun">(</span><span class="str">'app/data_binding_main'</span><span class="pun">)</span><span class="pln">
...
</span><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">AppComponent</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"./data_binding_app.component"</span><span class="pun">;</span><span class="pln">     </span><span class="com">//importing component function</span><span class="pln">
...
<b>data_binding_app.component.ts</b>
<pre class="prettyprint notranslate prettyprinted"><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">Component</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">'angular2/core'</span><span class="pun">;</span><span class="pln">
   ...
   `</span><span class="pln">
     ...
     </span><span class="kwd">public</span><span class="pln"> </span><span class="typ">Items</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="pun">[</span><span class="pln">
                     </span><span class="pun">{</span><span class="pln">name</span><span class="pun">:</span><span class="pln"> </span><span class="str">"Butter"</span><span class="pun">},</span><span class="pln">
                     </span><span class="pun">{</span><span class="pln">name</span><span class="pun">:</span><span class="pln"> </span><span class="str">"Milk"</span><span class="pun">},</span><span class="pln">
                     </span><span class="pun">{</span><span class="pln">name</span><span class="pun">:</span><span class="pln"> </span><span class="str">"Yogurt"</span><span class="pun">},</span><span class="pln">
                     </span><span class="pun">{</span><span class="pln">name</span><span class="pun">:</span><span class="pln"> </span><span class="str">"Cheese"</span><span class="pun">},</span><span class="pln">
                  </span><span class="pun">];</span><span class="pln">
     </span><span class="kwd">public</span><span class="pln"> clickedItem </span><span class="pun">=</span><span class="pln"> </span><span class="pun">{</span><span class="pln">name</span><span class="pun">:</span><span class="pln"> </span><span class="str">""</span><span class="pun">};</span><span class="pln">
     onItemClicked</span><span class="pun">(</span><span class="typ">Item</span><span class="pun">)</span><span class="pln"> </span><span class="pun">{</span><span class="pln">
        </span><span class="kwd">this</span><span class="pun">.</span><span class="pln">clickedItem </span><span class="pun">=</span><span class="pln"> </span><span class="typ">Item</span><span class="pun">;</span><span class="pln">
     </span><span class="pun">}</span><span class="pln">
...
<ul class="list">
   ...
   <li>
      <p>Next is <i>*ngFor</i> directive creates the view exports which we bind to in the template. The * is a shorthand for using Angular 2 template syntax with the template tag.</p>
   </li>
   <li>
      <p>The local variable <i>Item</i> can be referenced in the template and get the index of the array. When you click on the item value, the <i>onItemClicked()</i> event will get activate and Angular 2 will bind the model name from the array with the local variable of template. </p>
   </li>
   <li>
      <p>The model name <i>clickedItem</i> is binded with <i>name</i> and displays the item name in the text box when user click on item name from the list.</p>
   </li>
</ul>
<h4>Output</h4>
...
<ul class="list">
   <li>
      <p>Save above HTML code as <b>angular2_data_binding.html</b> file in your server root folder.</p>
   </li>
   <li>
      <p>Open this HTML file as http://localhost/angular2_data_binding.html and output as below gets displayed.</p>
   </li>
</ul>
...
<div class="row">
<a href="498_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="500_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
