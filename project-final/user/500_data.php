...
<h4>Description</h4>
<p>You can display the data with the help of binding controls in the UI. Angular will display the data by using interpolation and other binding properties such as using binding in HTML template to the Angular component properties.</p>
<h4>Example</h4>
<p>The below example describes use of displaying data in the Angular 2:</p>
<pre class="prettyprint notranslate tryit prettyprinted" style="cursor: default;"><span class="dec">&lt;!DOCTYPE html&gt;</span><span class="pln">
    ...
    </span><span class="tag">&lt;title&gt;</span><span class="pln">Angular 2 Data Display</span><span class="tag">&lt;/title&gt;</span><span class="pln">
      ...
      </span><span class="typ">System</span><span class="pun">.</span><span class="kwd">import</span><span class="pun">(</span><span class="str">'app/datadisplay_main'</span><span class="pun">)</span><span class="pln">
...
</span><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">MyTemplate</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"./datadisplay_app.component"</span><span class="pln">
...
<b>datadisplay_app.component.ts</b>
<pre class="prettyprint notranslate prettyprinted"><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">Component</span><span class="pun">,</span><span class="pln"> </span><span class="typ">View</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"angular2/core"</span><span class="pun">;</span><span class="pln">
   ...
   selector</span><span class="pun">:</span><span class="pln"> </span><span class="str">'my-app'</span><span class="pln">
    ...
    &lt;h4&gt;Showing data using component properties with interpolation&lt;/h4&gt;
    &lt;h3&gt;Player Name:{{player}}&lt;/h3&gt;
    &lt;h3&gt;He is famous in: {{sport}}&lt;/h3&gt;&lt;br&gt;

    &lt;h4&gt;Showing data using constructor or variable initialization&lt;/h4&gt;
    &lt;h3&gt;India capital is: {{capital}}&lt;/h3&gt;&lt;br&gt;

    &lt;h4&gt;Showing data using array property with NgFor&lt;/h4&gt;
...
</span><span class="kwd">export</span><span class="pln"> </span><span class="kwd">class</span><span class="pln"> </span><span class="typ">MyTemplate</span><span class="pln"> </span><span class="pun">{</span><span class="pln">
   player</span><span class="pun">:</span><span class="pln"> </span><span class="str">'M.S. Dhoni '</span><span class="pun">;</span><span class="pln">
   sport</span><span class="pun">:</span><span class="str">'Cricket'</span><span class="pun">;</span><span class="pln">

capital</span><span class="pun">:</span><span class="pln"> </span><span class="kwd">string</span><span class="pun">;</span><span class="pln">
constructor</span><span class="pun">()</span><span class="pln"> </span><span class="pun">{</span><span class="pln">
   </span><span class="kwd">this</span><span class="pun">.</span><span class="pln">capital </span><span class="pun">=</span><span class="pln"> </span><span class="str">'New Delhi'</span><span class="pun">;</span><span class="pln">
</span><span class="pun">}</span><span class="pln">

fruits </span><span class="pun">=</span><span class="pln"> </span><span class="pun">[</span><span class="str">'Apple'</span><span class="pun">,</span><span class="pln"> </span><span class="str">'Orange'</span><span class="pun">,</span><span class="pln"> </span><span class="str">'Mango'</span><span class="pun">,</span><span class="pln"> </span><span class="str">'Grapes'</span><span class="pun">];</span><span class="pln">
   myfruit </span><span class="pun">=</span><span class="pln"> </span><span class="kwd">this</span><span class="pun">.</span><span class="pln">fruits</span><span class="pun">[</span><span class="lit">1</span><span class="pun">];</span><span class="pln">
...
<ul class="list">
<li><p>Save above HTML code as <b>angular2_data_display.html</b> file in your server root folder.</p></li>
<li><p>Open this HTML file as http://localhost/angular2_data_display.html and output as below gets displayed.</p></li>
</ul>
...
<div class="row">
<a href="499_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="501_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
