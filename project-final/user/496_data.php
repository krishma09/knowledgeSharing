...
<h4>Description</h4>
<p>The component is a controller class with a template which mainly deals with a view of the application and logic on the page. It is a bit of code can be used throughout an application. The component knows how to render itself and configure dependency injection.</p>
<p>The component contains two important things; one is <i>view</i> and another one is <i>some logic</i>.</p>
<h4>Example</h4>
<p>The below example describes use of component in the Angular 2:</p>
<pre class="prettyprint notranslate tryit prettyprinted" style="cursor: default;"><span class="dec">&lt;!DOCTYPE html&gt;</span><span class="pln">
      ...
      </span><span class="tag">&lt;title&gt;</span><span class="pln">Angular 2 Component</span><span class="tag">&lt;/title&gt;</span><span class="pln">
            ...
            </span><span class="com">//transpiler tool converts TypeScript to JavaScript</span><span class="pln">
            ...
            </span><span class="com">//emitDecoratorMetadata flag used by JavaScript output to create metadata from the decorators</span><span class="pln">
         ...
         </span><span class="typ">System</span><span class="pun">.</span><span class="kwd">import</span><span class="pun">(</span><span class="str">'app/component_main'</span><span class="pun">)</span><span class="pln">
   ...
   </span><span class="com">&lt;!--When Angular calls the bootstrap function in main.ts, it reads the Component metadata, finds the 'app' selector, locates an element tag named app, and loads the application between those tags.--&gt;</span><span class="pln">
   </span><span class="tag">&lt;body&gt;</span><span class="pln">
      </span><span class="tag">&lt;app&gt;</span><span class="pln">Loading...</span><span class="tag">&lt;/app&gt;</span><span class="pln">
   </span><span class="tag">&lt;/body&gt;</span><span class="pln">
...
</span><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">App</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"./component_app.component"</span><span class="pln">         </span><span class="com">//importing component function</span><span class="pln">

bootstrap</span><span class="pun">(</span><span class="typ">App</span><span class="pun">);</span></pre>
<p>Now we will create a component in TypeScript(.ts) file which we will create component and view for the component.</p>
<b>component_app.component.ts</b>
<pre class="prettyprint notranslate prettyprinted"><span class="com">// component's metadata can be accessed using this primary Angular library</span><span class="pln">
</span><span class="kwd">import</span><span class="pln"> </span><span class="pun">{</span><span class="typ">Component</span><span class="pun">,</span><span class="pln"> </span><span class="typ">View</span><span class="pun">}</span><span class="pln"> </span><span class="kwd">from</span><span class="pln"> </span><span class="str">"angular2/core"</span><span class="pun">;</span><span class="pln">
   ...
   selector</span><span class="pun">:</span><span class="pln"> </span><span class="str">'app'</span><span class="pln">  </span><span class="com">//specifies selector for HTML element named 'app'</span><span class="pln">
</span><span class="pun">})</span><span class="pln">

</span><span class="lit">@View</span><span class="pun">({</span><span class="pln">
  </span><span class="com">//template property holds component's companion template that tells Angular how to render a view</span><span class="pln">
  </span><span class="kwd">template</span><span class="pun">:</span><span class="pln"> </span><span class="str">'&lt;h4&gt;Welcome to {{name}}&lt;/h4&gt;'</span><span class="pln">
</span><span class="pun">})</span><span class="pln">
   ...
   name </span><span class="pun">:</span><span class="pln"> </span><span class="str">'Tutorialspoint!!!'</span><span class="pln">
</span><span class="pun">}</span></pre>
<h4>Output</h4>
<p>When you run the above code, it will display the text specified within the <i>template</i> option which is defined in the <i>component_app.component.ts</i> file and holds component's companion template that tells Angular how to render a view.</p>
...
<ul class="list">
   <li>
      <p>Save above HTML code as <b>angular2_components.html</b> file in your server root folder.</p>
   </li>
   <li>
      <p>Open this HTML file as http://localhost/angular2_components.html and output as below gets displayed.</p>
   </li>
</ul>
...
<div class="row">
<a href="495_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="497_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
