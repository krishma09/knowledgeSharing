...
<pre class="result notranslate">char greeting[6] = {'H', 'e', 'l', 'l', 'o', '\0'};
</pre>
<p>If you follow the rule of array initialization then you can write the above statement as follows −</p>
<pre class="result notranslate">char greeting[] = "Hello";
</pre>
...
<p>Actually, you do not place the <i>null</i> character at the end of a string constant. The C compiler automatically places the '\0' at the end of the string when it initializes the array. Let us try to print the above mentioned string −</p>
...
<pre class="prettyprint notranslate tryit prettyprinted"><span class="com">#include</span><span class="pln"> </span><span class="str">&lt;stdio.h&gt;</span><span class="pln">
   ...
   </span><span class="kwd">char</span><span class="pln"> str1</span><span class="pun">[</span><span class="lit">12</span><span class="pun">]</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="str">"Hello"</span><span class="pun">;</span><span class="pln">
   </span><span class="kwd">char</span><span class="pln"> str2</span><span class="pun">[</span><span class="lit">12</span><span class="pun">]</span><span class="pln"> </span><span class="pun">=</span><span class="pln"> </span><span class="str">"World"</span><span class="pun">;</span><span class="pln">
   </span><span class="kwd">char</span><span class="pln"> str3</span><span class="pun">[</span><span class="lit">12</span><span class="pun">];</span><span class="pln">
   ...
   printf</span><span class="pun">(</span><span class="str">"strcpy( str3, str1) :  %s\n"</span><span class="pun">,</span><span class="pln"> str3 </span><span class="pun">);</span><span class="pln">
   ...
   printf</span><span class="pun">(</span><span class="str">"strcat( str1, str2):   %s\n"</span><span class="pun">,</span><span class="pln"> str1 </span><span class="pun">);</span><span class="pln">
   ...
   printf</span><span class="pun">(</span><span class="str">"strlen(str1) :  %d\n"</span><span class="pun">,</span><span class="pln"> len </span><span class="pun">);</span><span class="pln">

   </span><span class="kwd">return</span><span class="pln"> </span><span class="lit">0</span><span class="pun">;</span><span class="pln">
</span><span class="pun">}</span></pre>
<p>When the above code is compiled and executed, it produces the following result −</p>
<pre class="result notranslate">strcpy( str3, str1) :  Hello
...
<div class="row">
<a href="210_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="212_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
