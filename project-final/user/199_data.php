...
<pre class="prettyprint notranslate prettyprinted"><span class="pln">printf</span><span class="pun">(</span><span class="str">"Hello, World! \n"</span><span class="pun">);</span></pre>
<p>The individual tokens are −</p>
<pre class="prettyprint notranslate prettyprinted"><span class="pln">printf
</span><span class="pun">(</span><span class="pln">
</span><span class="str">"Hello, World! \n"</span><span class="pln">
</span><span class="pun">)</span><span class="pln">
</span><span class="pun">;</span></pre>
<h4>Semicolons</h4>
...
<p>Given below are two different statements −</p>
<pre class="prettyprint notranslate prettyprinted"><span class="pln">printf</span><span class="pun">(</span><span class="str">"Hello, World! \n"</span><span class="pun">);</span><span class="pln">
...
<div class="row">
<a href="198_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="200_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
