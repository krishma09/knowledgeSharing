...
<p>A function definition in C programming consists of a <i>function header</i> and a <i>function body</i>. Here are all the parts of a function −</p>
<ul class="list">
...
<h4>Example</h4>
<p>Given below is the source code for a function called <b>max()</b>. This function takes two parameters num1 and num2 and returns the maximum value between the two −</p>
...
<p>Parameter names are not important in function declaration only their type is required, so the following is also a valid declaration −</p>
...
<p>To call a function, you simply need to pass the required parameters along with the function name, and if the function returns a value, then you can store the returned value. For example −</p>
<pre class="prettyprint notranslate tryit prettyprinted"><span class="com">#include</span><span class="pln"> </span><span class="str">&lt;stdio.h&gt;</span><span class="pln">
   ...
   printf</span><span class="pun">(</span><span class="pln"> </span><span class="str">"Max value is : %d\n"</span><span class="pun">,</span><span class="pln"> ret </span><span class="pun">);</span><span class="pln">
...
<div class="row">
<a href="206_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignleft sc_buttons_st1 sc_buttons_st5">Previous</button></a>

<div style="padding-right:50px">

<a href="208_data.php"> <button class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small alignright sc_buttons_st1 sc_buttons_st5">NEXT</button></a>
</div>
 </div>
