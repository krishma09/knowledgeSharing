	...
	function allLetter(uname)
{
	...
	else
	{
			...
			uname.value="";
			uname.focus();
			alert('Name must not be empty and have Alphabetic characters only');
			return false;
	}
}
</script>
...
<div class="caption">
   ...
   <img src="../project-final/user_images/<?php echo $u_pic; ?>" height=220px width=220px alt="Profile Pic"><br><br>
...
<div class="col-md-4">
	<div class="form-group">
		...
		<input type="text" class="form-control" name="u_name" value="<?php echo $u_name; ?>" onblur="return allLetter(u_name);">
...
<div class="col-md-4">
 <div class="form-group">
		...
		<font size="4">
		<input type="radio" style="width:17px;height:17px";" name="u_gender" value="female" <?php if($u_gender=="female") echo "checked"; ?>>Female
