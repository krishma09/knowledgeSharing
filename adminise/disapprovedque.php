...
<title>Disapproved Questions</title>
...
<div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading"><center><font size="5" color="black">DISAPPROVED QUESTIONS</font></center></h2>
                                </header>
                                <div class="contents">
					...
					echo '<td><center><a href="delque.php?id='.$row["pk_q_id"].'"><button type="button" class="btn btn-danger" aria-label="Left Align"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a></center></td>';
					echo '</tr>';
						...
						?>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th><input type="text" name="search_engine" value="Search Title" class="search_init" /></th>
                                                    <th><input type="text" name="search_browser" value="Search Category" class="search_init" /></th>
                                                    <th><input type="text" name="search_platform" value="Search User Name" class="search_init" /></th>
